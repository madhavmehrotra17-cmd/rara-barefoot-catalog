...
const cssToAdd = `
/* 1. Perfect Gradient Background (White to Gray) - Applying to ALL product grids across all pages */
.card__media, .product-card__media, .card-wrapper .media,
.search-filters__product-image-wrapper, .search-filters__product-image,
...
.search-filters__product-image-wrapper img, .search-filters__product-image img,
.search-filters__product-item-grid-view-layout-image img {
...
.search-filters__product-image-wrapper img:first-child, .search-filters__product-image img:first-child,
.search-filters__product-item-grid-view-layout-image img:first-child {
    position: relative !important;
}
...
.search-filters__product-image-wrapper::before, .search-filters__product-image::before,
.card__media::after, .product-card__media::after, .card-wrapper .media::after,
.search-filters__product-image-wrapper::after, .search-filters__product-image::after {
