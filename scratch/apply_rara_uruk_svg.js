...
console.log('Upgrading barefoot science widget to show the original RARA URUK BLUE shoe design...');

// 1. Locate the barefoot SVG block
...
if (bStartIdx !== -1) {
  const footLabelIdx = content.indexOf('Top Splay & Sideways Zero-Drop posture</span>', bStartIdx);
  if (footLabelIdx !== -1) {
...
const raraUrukSVGMarkup = `<div class="foot-graphic-wrapper active" id="visual-barefoot">
        <!-- SVG for Barefoot Foot - Original RARA URUK BLUE Side-by-Side Top & Side Views -->
        <svg viewBox="0 0 360 240" class="foot-svg barefoot-svg">
          <!-- ==================== LEFT HALF: TOP-DOWN VIEW ==================== -->
          <g transform="translate(5, 5) scale(0.85)">
            <!-- Outer Outsole Welt in original RARA gum rubber color -->
            <path d="M100 11 C139 11, 155 41, 152 67 C149 97, 139 127, 131 167 C126 197, 121 227, 100 227 C79 227, 74 197, 69 167 C61 127, 51 97, 48 67 C45 41, 61 11, 100 11 Z" fill="none" stroke="#C68A4C" stroke-width="3px" />
            <!-- Shoe Body / Upper in Rara mesh blue tint -->
            <path d="M100 15 C135 15, 150 45, 148 70 C145 100, 135 130, 128 170 C123 200, 118 225, 100 225 C82 225, 77 200, 72 170 C65 130, 55 100, 52 70 C50 45, 65 15, 100 15 Z" fill="rgba(100, 140, 180, 0.08)" stroke="#648CB4" stroke-width="2.5px" />
            ...
            <!-- Wide Spacious Toe Cap Stitching (Anatomical splay) -->
            <path d="M53 71 C71 89, 129 89, 147 71" fill="none" stroke="#648CB4" stroke-width="1.5px" stroke-dasharray="3.5 2" />
            <path d="M54 75 C72 93, 128 93, 146 75" fill="none" stroke="#648CB4" stroke-width="1px" stroke-dasharray="2 1.5" />
          ...
          <g transform="translate(182, 16) scale(0.95)">
            ...
            <!-- Midfoot gum sole upward wrap (Iconic Uruk design feature) -->
            ...
            <!-- White RARA Monogram Logo on Midfoot Panel -->
            <rect x="62" y="128" width="16" height="16" rx="3.5" fill="#ffffff" />
            <!-- Inner Monogram a/R details -->
            <path d="M 66,136 H 74 M 66,139 H 74 M 70,133 V 139" stroke="#4B779F" stroke-width="1.8px" stroke-linecap="round" />
            ...
            <!-- TRU BIOMECHANICS Heel branding text -->
            <text x="145" y="152" font-size="5" font-family="'Geist', sans-serif" font-weight="700" fill="#ffffff" text-anchor="end" transform="rotate(-75 145 152)">TRU BIOMECHANICS</text>
...
const newContent = content.replace(content.substring(bStartIdx, bEndIdx), raraUrukSVGMarkup);
fs.writeFileSync(filePath, newContent, 'utf8');
console.log('[SUCCESS] Successfully upgraded barefoot SVG to show original RARA URUK BLUE shoelaces, gum outsole, knit blue mesh, midfoot panels, white monogram logo, and TRU BIOMECHANICS branding!');
